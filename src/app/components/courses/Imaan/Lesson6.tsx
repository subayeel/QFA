      ...
      <article className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <section id="introduction" className="mb-16 scroll-mt-20">
          ...
          <p className="text-xl leading-relaxed mb-6 text-gray-700 dark:text-gray-300">
            Let's explore something really important—how we can know if Prophet
            Muhammad ﷺ was truly sent by God. If you've already seen how the
            Quran is divine, this becomes simpler, because the Quran clearly
            states:
          </p>
          ...
          <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
            Let's examine each possibility logically and see which one makes the
            most sense. This approach helps us think critically about this
            important question!
          </p>
        </section>
        ...
        <section id="lying" className="mb-16 scroll-mt-20">
          ...
          <p className="text-xl leading-relaxed mb-6 text-gray-700 dark:text-gray-300">
            Let's look at what we know about Muhammad's character ﷺ, especially
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 my-8">
            ...
            <ul className="space-y-4 text-gray-700 dark:text-gray-300">
              ...
              <li className="flex items-start gap-3">
                ...
                />
                <div>
                  He avoided the common vices of his society (like idol worship,
              ...
              <li className="flex items-start gap-3">
                ...
                />
                <div>
                  He was known for caring for orphans, the elderly, and helping
                  his community
                </div>
              </li>
            </ul>
          ...
          <p className="text-xl leading-relaxed mb-6 text-gray-700 dark:text-gray-300">
            Even his enemies acknowledged his honesty! Consider this fascinating
            historical account:
          </p>
        ...
        <section id="deluded" className="mb-16 scroll-mt-20">
            ...
            <div className="space-y-4">
              <div className="bg-white dark:bg-gray-800 p-4 rounded-lg">
                ...
                <span className="text-gray-700 dark:text-gray-300">
                  {" "}
                  Including laws about family, economics, diet, hygiene, social
                  relations, and spiritual practices—all still benefiting
                  millions today
                </span>
              </div>
              <div className="bg-white dark:bg-gray-800 p-4 rounded-lg">
          ...
          <p className="text-xl leading-relaxed mb-6 text-gray-700 dark:text-gray-300">
            Let's also consider a specific incident that reveals his character:
          </p>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 my-8 border-l-4 border-blue-300 dark:border-blue-600">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300">
              He rejected the chance to use this coincidence for personal gain,
              instead teaching scientific accuracy and focusing on God alone.
            </p>
          </div>

          <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
            When we consider the consistency, complexity, and lasting impact of
            his teachings, along with his rational behavior in moments where a
            deluded person would likely act differently, this explanation also
        ...
        <section id="truthful" className="mb-16 scroll-mt-20">
          ...
          <p className="text-xl leading-relaxed mb-6 text-gray-700 dark:text-gray-300">
            When we've carefully examined the first two possibilities and found
            them inadequate to explain the historical facts, we're left with the
            third option—that Muhammad ﷺ was indeed telling the truth about
            ...
            <ul className="space-y-4 text-gray-700 dark:text-gray-300">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  — Known for honesty before and after prophethood, even by his
                  enemies
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  — He faced hardship and lived simply despite opportunities for
                  wealth and power
                </div>
              </li>
              <li className="flex items-start gap-3">
          ...
          <p className="text-xl leading-relaxed mb-6 text-gray-700 dark:text-gray-300">
            The most reasonable conclusion, when we eliminate the alternatives,
            is that Muhammad ﷺ was indeed what he claimed to be—a messenger
            chosen by God to deliver divine guidance to humanity.
          </p>

          <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
            This perspective aligns with what the Quran says about him and
            explains why his message has had such a profound and lasting impact
            on human history.
          </p>
        </section>
        ...
        <section id="conclusion" className="mb-16 scroll-mt-20">
          ...
          <p className="text-xl leading-relaxed mb-6 text-gray-700 dark:text-gray-300">
            ...
            the impact he's had on history, the evidence points to the truth of
            his claim to be God's messenger.
          </p>
          ...
          <p className="text-xl leading-relaxed mb-6 text-gray-700 dark:text-gray-300">
            ...
            learning from his teachings and example—guidance that has positively
            transformed countless lives throughout history and continues to do
            so today.
          </p>
