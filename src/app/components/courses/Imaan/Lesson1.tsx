    ...
    <main className="max-w-4xl mx-auto px-4 py-8">
      <article className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <section id="natural-disposition" className="mb-16 scroll-mt-20">
          ...
          <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-6 my-8">
            ...
            <p className="text-lg leading-relaxed mb-4 text-gray-700 dark:text-gray-300">
              ...
              show children's innate tendency to attribute purpose and design to
              natural phenomena:
            </p>
            <ul className="space-y-3 text-gray-700 dark:text-gray-300">
              <li className="flex items-start gap-3">
        ...
        <section id="common-sense" className="mb-16 scroll-mt-20">
          ...
          <p className="text-xl leading-relaxed mb-6 text-gray-700 dark:text-gray-300">
            It is something that is universal and common! It's something we can
            all agree on, it's what people agree is the best thing to use to
            make decisions in their everyday lives and also by and large, it's
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 my-8">
            ...
            <p className="text-lg leading-relaxed mb-4 text-gray-700 dark:text-gray-300">
              Imagine this scenario: A man wearing nothing but underpants knocks
              on your door, claiming to be the electricity meter reader. How
        ...
        <section id="design-argument" className="mb-16 scroll-mt-20">
          ...
          <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-6 my-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                Now, imagine finding a mobile phone in the Arabian desert. Would
                you believe it formed naturally through wind blowing, sun
                shining, or lightning striking?
              </p>
              <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                Of course not! The complexity of the phone's design and function
                points to a designer. Similarly, the universe's vast complexity
                and orderliness suggest a Creator.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="universe-order" className="mb-16 scroll-mt-20">
          ...
          <div className="grid md:grid-cols-2 gap-6 my-8">
            <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-6">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                Our planet rotates once every 24 hours. If a day was 30-40 years
                long:
              </p>
          ...
          <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
            ...
            breathe contains the right amount of oxygen and nitrogen for humans
            to survive and for plants to thrive.
          </p>
        </section>
        ...
        {/* Summary Section */}
        <section id="philosophical-perspective" className="mb-16 scroll-mt-20">
          ...
          <p className="text-xl leading-relaxed mb-6 text-gray-700 dark:text-gray-300">
            The logical proofs and arguments presented lead us to the conclusion
            that there must be a unique, necessary, and independent Creator
            behind the universe. Here's a summary of the key points:
          </p>
          ...
          <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
            These proofs and arguments collectively point to the existence of a
            single, necessary, and independent Creator who is the foundation of
            all existence.
          </p>

          {/* <div className="flex justify-center mt-8">
            <Button
              onClick={() => (window.location.href = "/primary/god/philosophy")}
              variant="outline"
              className="border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800"
            >
              View Detailed Philosophy <ArrowRight size={16} className="ml-2" />
            </Button>
          </div> */}
        </section>
      </article>
