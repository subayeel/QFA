...
import { HifzPlanData } from "@/types/type"; // Import the type
import {
  QURAN_SURAHS,
  getVersesBySurahs,
  TOTAL_QURAN_VERSES,
...
export default function Step3_CurrentHifz({
  ...
  return (
    <div className="space-y-2">
      <div className="flex justify-between flex-col md:flex-row items-start w-full mb-8 gap-2">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between w-full gap-2">
        <p className="text-sm text-gray-700">
          Select the Surahs you have already memorized completely.
        </p>
